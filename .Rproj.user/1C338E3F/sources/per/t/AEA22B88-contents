#' Data package for seafloor climage change (TaiwanSSP585)
#'
#' TaiwanSSP585 package contains ensemble model average of CMIP6 historical and ssp126 climate change projections on the seafloor for Taiwan EEZ.
...
#' The ensemble averages of various model statistics were calculated among the five models for the periods of 1950 to 2014 (historial), 2041 to 2060 (ssp126) and 2081 to 2100 (ssp126).
